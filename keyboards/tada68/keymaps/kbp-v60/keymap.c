...
[_BL] = LAYOUT_ansi(
  ...
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        MO(_FL), KC_ALGR, KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT),
...
[_FL] = LAYOUT_ansi(
  ...
  _______, _______, KC_RGUI,                   _______,                            _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R),
};
