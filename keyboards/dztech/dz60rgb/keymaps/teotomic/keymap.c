...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_LAYER1] = LAYOUT( /* FN */
		    ...
		    KC_CAPS,  KC_TRNS,  KC_UP,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_CALC,  KC_TRNS,  KC_INS,   KC_HOME,  KC_UP,    KC_END,   KC_PAUS,  KC_PGUP,\
		    KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_GRV,   KC_INS,   KC_LEFT,  KC_DOWN,  KC_RIGHT,           KC_PGDOWN,\
		    KC_TRNS,  BL_TOGG,  BL_STEP,  BL_BRTG,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_END,   KC_PGDOWN,KC_PGUP,            KC_GRV,\
		    KC_TRNS,  KC_TRNS,  KC_TRNS,                      TO(4),                        KC_TRNS,  KC_TRNS,  KC_HOME,  KC_PGDOWN,          KC_END),
