...
[_FN] = LAYOUT(
  ...
  _______, KC_LEFT, KC_DOWN, KC_RIGHT,KC_DEL,  KC_SLCK, KC_PGDN, KC_TILD, KC_INS,  KC_LEFT, KC_DOWN, KC_RIGHT,_______, KC_PGDN,\
  _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_BTN1, _______,\
  _______, _______, _______,                   _______,                            _______, _______, KC_MS_L, KC_MS_D),
};
